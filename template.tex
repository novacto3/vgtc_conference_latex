%% Uncomment the following line to enable PDF tagging (for accessibility and other purposes).
%% This requires the tagpdf package and compilation with pdfLaTeX or LuaLaTeX.
%%Note that this is an experimental feature and may not work with all packages.
%\DocumentMetadata{lang=en, pdfversion=1.7, tagging=on}
...
\shortautor{Roy G. Biv, Ed Grimley, and Martha Stewart}

%% A teaser figure can be included as follows. The label for referencing is fig:teaser.
\teaser{
  \centering
